...
public class QRGenerador1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        qrCode.close();*/
        QRGenerador1 q = new QRGenerador1();
        q.QrAlumnoNC("18710132", "Rant QrId");

    }

    public void QrAlumno(Estudiante nuevo, String ruta) throws FileNotFoundException, IOException {
        String data = nuevo.toString();
        BitMatrix matriz;
        Writer writer = new QRCodeWriter();
        try {
            matriz = writer.encode(data, BarcodeFormat.QR_CODE, qrTamAncho, qrTamAlto);
    ...
    public void QrAlumnoNC(String nc, String ruta) throws FileNotFoundException, IOException {
        String data = nc;
        BitMatrix matriz;
        Writer writer = new QRCodeWriter();
        try {
        ...
        this.ruta = ruta;
        FileOutputStream qrCode = new FileOutputStream("src\\" + ruta + ".png");
        //FileOutputStream qrCode = new FileOutputStream("C:\\Users\\Admin\\Pictures\\WOW\\" + ruta + ".png");
        ImageIO.write(imagen, formato, qrCode);
        System.out.println("Listo!");
        qrCode.close();
    ...
    public void QrLibro(Libro nuevo, String ruta) throws FileNotFoundException, IOException {
        String data = nuevo.toString();
        BitMatrix matriz;
        Writer writer = new QRCodeWriter();
        try {
